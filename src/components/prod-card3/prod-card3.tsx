...
export const ProductCard3: React.FC<ProductCardProps> = ({
  imageUrl = "https://cdn.builder.io/api/v1/image/assets/TEMP/afddd52ebf26fcf0b16aab7a426427fa8bd28caf?width=396",
